...
public class CodeSnippetCommandProvider implements CommandProvider {
    ...
    class PasteSnippetCommand implements Command {
        ...
        public String getTitle() {
            return "Paste Snip: " + codeSnippet.getName();
        }

        @Override
        public String getDetailHtml() {
            return codeSnippet.getName();
        }
        ...
        public void perform() {
            EventQueue.invokeLater(new Runnable() {
                @Override
                public void run() {
                    openDocsModel.insertSelectedText(codeSnippet.getCode());
                }
            });
    ...
    class RunSnippetCommand extends PasteSnippetCommand {
        ...
        @Override
        public String getTitle() {
            return "Run Snip: " + codeSnippet.getName();
        }

        @Override
        public void perform() {
            queryManager.sendQuery(codeSnippet.getCode(), getTitle());
        }
    }
}
